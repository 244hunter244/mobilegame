const historia = {
    ...
    perguntar_identidade: {
        personagem: "Morte",
        texto: "A figura não se move. 'Eu sou o fim da sua linha, Arthur. A Morte. O e-mail foi apenas a formalidade do protocolo atual. Parada cardíaca súbita causada por um aneurisma assintomático. Às 23h59, seu sistema desliga.'",
        opcoes: [
    ...
    reacao_desespero: {
        personagem: "Morte",
        texto: "'O como não importa, Arthur. O quando já está definido. Sugiro que saia deste quarto. O cheiro de estagnação aqui é incômodo.' Sem emitir som, ela se move para a porta, esperando por você.",
        opcoes: [
    ...
    ir_ao_parque: {
        personagem: "Narrador",
        texto: "Cenário: Parque da Cidade - Fim da Tarde. O céu está cinzento e nublado. Arthur observa as pessoas caminhando. A Morte está de pé ao lado dele, imóvel como uma estátua de mármore.",
        opcoes: [
    ...
    resposta_fria: {
        personagem: "Morte",
        texto: "Ela olha fixamente para o horizonte, com olhos vazios. 'Sinto o mesmo que a gravidade sente quando uma maçã cai da árvore. Nada. É apenas mecânica, Arthur. Tudo o que começa precisa terminar. Sou apenas a tesoura que corta o fio.'",
        opcoes: [
    ...
    o_encontro: {
        personagem: "Narrador",
        texto: "Cenário: Restaurante Antigo - 23h30. Mesa de canto, meia-luz. Uma música de jazz melancólica toca ao fundo. Arthur tem uma taça de vinho na mão. A Morte senta-se rigidamente do outro lado, apenas observando.",
        opcoes: [
    ...
    encontro_dialogo_1: {
        personagem: "Morte",
        texto: "'Não sinto fome. E a matéria orgânica se decompõe rapidamente na minha presença. Beba o seu vinho, Arthur. O tempo está se esgotando.' Sua voz não carrega nenhum traço de carinho ou flerte. É puramente profissional.",
        opcoes: [
    ...
    encontro_dialogo_3: {
        personagem: "Morte",
        texto: "Sua expressão permanece perfeitamente rígida. 'Eu testemunho todos eles. Você existiu, Arthur. Mas sua cota de tempo foi gasta.' De repente, uma dor lancinante surge na base do seu crânio. Sua visão começa a falhar.",
        opcoes: [
    ...
    fim_estatico: {
        personagem: "Morte",
        texto: "Ela estende a mão metálica e fria sobre a mesa, tocando seus dedos sem qualquer aperto reconfortante. É como tocar uma estátua de gelo. 'O escuro é inevitável, Arthur. Mas eu estou aqui. Minha presença é a última coisa que você irá registrar.'",
        opcoes: [
    ...
    game_over: {
        personagem: "Morte",
        texto: "A tela apaga por completo. O jazz some. No silêncio absoluto, a voz ecoa uma última vez: 'Arthur. Hora do óbito: 23h59. Registro encerrado.' O som de passos pesados se afasta até sumir.",
        opcoes: [
